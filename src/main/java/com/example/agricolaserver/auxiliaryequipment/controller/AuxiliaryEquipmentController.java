...
public class AuxiliaryEquipmentController {
    ...
    public ResponseEntity<List<AuxiliaryEquipmentDTO>> getAuxiliaryEquipmentsByMemberId(@PathVariable Member member) {
        List<AuxiliaryEquipmentDTO> auxiliaryEquipments = auxiliaryEquipmentService.getAuxiliaryEquipmentsByMember(member);
        return ResponseEntity.ok(auxiliaryEquipments);
    }
    
    @GetMapping("/member/{memberId}/aux/{cardNumber}")
    public ResponseEntity<AuxiliaryEquipmentDTO> getAuxiliaryEquipmentByCardNumber(@PathVariable Member member, @PathVariable Integer cardNumber) {
        List<AuxiliaryEquipmentDTO> auxiliaryEquipments = auxiliaryEquipmentService.getAuxiliaryEquipmentsByMember(member);
