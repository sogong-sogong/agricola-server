...
public class AuxiliaryEquipmentController {
    ...
    public ResponseEntity<List<AuxiliaryEquipmentDTO>> getAuxiliaryEquipmentsByMemberId(@PathVariable Long memberId) {
        List<AuxiliaryEquipmentDTO> auxiliaryEquipments = auxiliaryEquipmentService.getAuxiliaryEquipmentsByMemberId(memberId);
        return ResponseEntity.ok(auxiliaryEquipments);
    }
    
    @GetMapping("/member/{memberId}/aux/{cardNumber}")
    public ResponseEntity<AuxiliaryEquipmentDTO> getAuxiliaryEquipmentByCardNumber(@PathVariable Long memberId, @PathVariable Integer cardNumber) {
        List<AuxiliaryEquipmentDTO> auxiliaryEquipments = auxiliaryEquipmentService.getAuxiliaryEquipmentsByMemberId(memberId);
